...
type SpanContext struct {
	...
	TraceID uint64 `protobuf:"varint,1,opt,name=TraceID,json=traceID,proto3" json:"TraceID,omitempty"`
	SpanID  uint64 `protobuf:"varint,2,opt,name=SpanID,json=spanID,proto3" json:"SpanID,omitempty"`
}
...
type Span struct {
	...
	ParentSpanID uint64               `protobuf:"varint,2,opt,name=ParentSpanID,json=parentSpanID,proto3" json:"ParentSpanID,omitempty"`
	Name         string               `protobuf:"bytes,3,opt,name=name,proto3" json:"name,omitempty"`
	Start        *timestamp.Timestamp `protobuf:"bytes,4,opt,name=Start,json=start,proto3" json:"Start,omitempty"` // [(gogoproto.customname) = "Start", (gogoproto.stdtime) = true, (gogoproto.nullable) = false];
...
type Field struct {
	...
	FieldType FieldType `protobuf:"varint,2,opt,name=FieldType,json=fieldType,proto3,enum=wire.FieldType" json:"FieldType,omitempty"`
...
type Field_NumericVal struct {
	NumericVal int64 `protobuf:"fixed64,3,opt,name=NumericVal,json=numericVal,proto3,oneof"`
}

type Field_StringVal struct {
	StringVal string `protobuf:"bytes,4,opt,name=StringVal,json=stringVal,proto3,oneof"`
}
...
var file_binary_proto_rawDesc = []byte{
	...
	0x01, 0x20, 0x01, 0x28, 0x04, 0x52, 0x07, 0x74, 0x72, 0x61, 0x63, 0x65, 0x49, 0x44, 0x12, 0x16,
	0x0a, 0x06, 0x53, 0x70, 0x61, 0x6e, 0x49, 0x44, 0x18, 0x02, 0x20, 0x01, 0x28, 0x04, 0x52, 0x06,
	0x73, 0x70, 0x61, 0x6e, 0x49, 0x44, 0x22, 0xda, 0x01, 0x0a, 0x04, 0x53, 0x70, 0x61, 0x6e, 0x12,
	...
	0x28, 0x04, 0x52, 0x0c, 0x70, 0x61, 0x72, 0x65, 0x6e, 0x74, 0x53, 0x70, 0x61, 0x6e, 0x49, 0x44,
	...
	0x05, 0x73, 0x74, 0x61, 0x72, 0x74, 0x12, 0x16, 0x0a, 0x06, 0x6c, 0x61, 0x62, 0x65, 0x6c, 0x73,
	...
	0x66, 0x69, 0x65, 0x6c, 0x64, 0x54, 0x79, 0x70, 0x65, 0x12, 0x20, 0x0a, 0x0a, 0x4e, 0x75, 0x6d,
	0x65, 0x72, 0x69, 0x63, 0x56, 0x61, 0x6c, 0x18, 0x03, 0x20, 0x01, 0x28, 0x10, 0x48, 0x00, 0x52,
	0x0a, 0x6e, 0x75, 0x6d, 0x65, 0x72, 0x69, 0x63, 0x56, 0x61, 0x6c, 0x12, 0x1e, 0x0a, 0x09, 0x53,
	0x74, 0x72, 0x69, 0x6e, 0x67, 0x56, 0x61, 0x6c, 0x18, 0x04, 0x20, 0x01, 0x28, 0x09, 0x48, 0x00,
	0x52, 0x09, 0x73, 0x74, 0x72, 0x69, 0x6e, 0x67, 0x56, 0x61, 0x6c, 0x42, 0x07, 0x0a, 0x05, 0x76,
