...
type Node_StringValue struct {
	StringValue string `protobuf:"bytes,3,opt,name=StringValue,json=stringValue,proto3,oneof"`
}

type Node_BooleanValue struct {
	BooleanValue bool `protobuf:"varint,4,opt,name=BooleanValue,json=booleanValue,proto3,oneof"`
}

type Node_IntegerValue struct {
	IntegerValue int64 `protobuf:"varint,5,opt,name=IntegerValue,json=integerValue,proto3,oneof"`
}

type Node_UnsignedValue struct {
	UnsignedValue uint64 `protobuf:"varint,6,opt,name=UnsignedValue,json=unsignedValue,proto3,oneof"`
}

type Node_FloatValue struct {
	FloatValue float64 `protobuf:"fixed64,7,opt,name=FloatValue,json=floatValue,proto3,oneof"`
}

type Node_RegexValue struct {
	RegexValue string `protobuf:"bytes,8,opt,name=RegexValue,json=regexValue,proto3,oneof"`
}

type Node_TagRefValue struct {
	TagRefValue string `protobuf:"bytes,9,opt,name=TagRefValue,json=tagRefValue,proto3,oneof"`
}

type Node_FieldRefValue struct {
	FieldRefValue string `protobuf:"bytes,10,opt,name=FieldRefValue,json=fieldRefValue,proto3,oneof"`
}
...
var file_predicate_proto_rawDesc = []byte{
	...
	0x56, 0x61, 0x6c, 0x75, 0x65, 0x18, 0x05, 0x20, 0x01, 0x28, 0x03, 0x48, 0x00, 0x52, 0x0c, 0x69,
	...
	0x65, 0x18, 0x07, 0x20, 0x01, 0x28, 0x01, 0x48, 0x00, 0x52, 0x0a, 0x66, 0x6c, 0x6f, 0x61, 0x74,
	0x56, 0x61, 0x6c, 0x75, 0x65, 0x12, 0x20, 0x0a, 0x0a, 0x52, 0x65, 0x67, 0x65, 0x78, 0x56, 0x61,
	0x6c, 0x75, 0x65, 0x18, 0x08, 0x20, 0x01, 0x28, 0x09, 0x48, 0x00, 0x52, 0x0a, 0x72, 0x65, 0x67,
	...
	0x74, 0x61, 0x67, 0x52, 0x65, 0x66, 0x56, 0x61, 0x6c, 0x75, 0x65, 0x12, 0x26, 0x0a, 0x0d, 0x46,
	0x69, 0x65, 0x6c, 0x64, 0x52, 0x65, 0x66, 0x56, 0x61, 0x6c, 0x75, 0x65, 0x18, 0x0a, 0x20, 0x01,
	0x28, 0x09, 0x48, 0x00, 0x52, 0x0d, 0x66, 0x69, 0x65, 0x6c, 0x64, 0x52, 0x65, 0x66, 0x56, 0x61,
